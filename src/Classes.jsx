...
//   const [allClasses, setAllClasses] = useState({ 1: [], 2: [], 3: [], 4: [], 5: [] });
//   const [selectedClass, setSelectedClass] = useState(1);
//   const [selectedApp, setSelectedApp] = useState(null);
//   const [selectedStudent, setSelectedStudent] = useState(null);
//   const userRole = localStorage.getItem("userRole");

//   // ১. Pending applications আনা
//   useEffect(() => {
...
//         alert(`"${rawClass}" class এখনো support করা হয় না (শুধু Class 1-5)`);
//         return;
//       }
...
//       // Results table (শুধু approved student-এর জন্য)
//       if (!isApplication && student.results && student.results.length > 0) {
//         y += 6;
//         pdf.setFillColor(16, 55, 65);
...
//         pdf.setFontSize(10);
//         pdf.setFont("helvetica", "bold");
//         pdf.text("Academic Results", 105, y + 7, { align: "center" });
//         y += 16;

//         // Table header
//         pdf.setFillColor(254, 240, 235);
//         pdf.rect(20, y - 5, 170, 10, "F");
//         pdf.setTextColor(254, 93, 55);
//         pdf.setFontSize(9);
//         pdf.text("Subject", 30, y);
//         pdf.text("Marks", 110, y);
//         pdf.text("Grade", 160, y);
//         y += 10;

//         student.results.forEach((res, i) => {
//           if (i % 2 === 0) {
//             pdf.setFillColor(249, 250, 251);
//             pdf.rect(20, y - 5, 170, 10, "F");
//           }
...
//           pdf.setFont("helvetica", "normal");
//           pdf.setFontSize(9);
//           pdf.text(res.subject || "", 30, y);
//           pdf.text(String(res.mark ?? ""), 110, y);
//           pdf.setFont("helvetica", "bold");
//           pdf.setTextColor(16, 185, 129);
//           pdf.text(res.grade || "", 160, y);
//           y += 12;
//         });
//       }
...
//   // ক্লাস অনুযায়ী pending applications গ্রুপ করা
...
//       {/* ===== অ্যাডমিন প্যানেল — ক্লাস ভিত্তিক ===== */}
//       {userRole === "admin" && (
//         <div style={adminPanelStyle}>
//           <h2 style={{ color: "#FE5D37", margin: "0 0 20px" }}>
//             Pending Admissions ({applications.length})
//           </h2>
...
//                       {app.phone || "No phone"} · {app.dob || "No DOB"}
//                     </p>
//                   </div>
//                   <div style={{ display: "flex", gap: "8px" }}>
//                     <button onClick={() => setSelectedApp(app)} style={detailsBtnStyle}>
//                       👁 Details
//                     </button>
//                     <button onClick={() => downloadPDF(app, true)} style={downloadBtnStyle}>
//                       ⬇ PDF
//                     </button>
//                     <button onClick={() => approveApplication(app)} style={approveBtnStyle}>
//                       ✓ Approve
//                     </button>
//                   </div>
//                 </div>
...
//               <h3 style={{ margin: 0, color: "#103741" }}>Application Details</h3>
//               <button onClick={() => setSelectedApp(null)} style={closeXBtnStyle}>✕</button>
//             </div>
...
//               />
//               <div>
//                 <p style={{ margin: 0, fontSize: "18px", fontWeight: "700", color: "#103741" }}>
...
//                   <span style={{ color: "#999", fontSize: "13px", minWidth: "130px" }}>{label}</span>
//                   <span style={{ color: "#103741", fontSize: "14px", fontWeight: "500", flex: 1, textAlign: "right" }}>{value}</span>
//                 </div>
//               ) : null
//             )}
...
//           <p style={{ textAlign: "center", color: "#ccc" }}>No students in this class</p>
//         )}
...
//               />
//               <div>
//                 <p style={{ margin: 0, fontWeight: "600", color: "#103741" }}>{st.name}</p>
//                 <p style={{ margin: 0, fontSize: "12px", color: "#999" }}>{st.address || "No address"}</p>
//               </div>
//             </div>
//             <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
//               <span style={{ fontSize: "13px", color: "#666" }}>Roll: {st.roll}</span>
//               <button onClick={() => setSelectedStudent(st)} style={detailsBtnStyle}>
//                 👁 Details
//               </button>
//             </div>
//           </div>
...
//               <button onClick={() => setSelectedStudent(null)} style={closeXBtnStyle}>✕</button>
//             </div>
...
//               />
//               <div>
//                 <p style={{ margin: 0, fontSize: "20px", fontWeight: "700", color: "#103741" }}>
//                   {selectedStudent.name}
//                 </p>
//                 <span style={classBadgeStyle}>Class {selectedStudent.class}</span>
//                 <span style={{ ...classBadgeStyle, background: "#f0fdf4", color: "#16a34a", marginLeft: "6px" }}>
...
//                 <p style={{ fontWeight: "700", color: "#103741", marginBottom: "8px" }}>
//                   Academic Results
//                 </p>
...
//                         <td style={{ ...tdStyle, color: "#10b981", fontWeight: "700" }}>{res.grade}</td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
...
//                 style={{ ...downloadBtnStyle, flex: 2, padding: "12px", fontSize: "14px" }}
//               >
//                 ⬇ Download PDF
//               </button>
//               <button
