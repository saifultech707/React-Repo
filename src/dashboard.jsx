      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', padding: '0 10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            {isSidebarOpen && <span style={{ fontWeight: 'bold', fontSize: '18px' }}>Code Horizon</span>}
          </div>
        ...
        <div style={{ background: '#e6f0ff', padding: '10px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', cursor: 'pointer' }}>
          <div style={{ background: '#007bff', color: 'white', width: '30px', height: '30px', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold' }}>J</div>
        ...
        <div style={{ padding: '10px', borderTop: '1px solid #ddd', marginTop: 'auto', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
           ...
           {isSidebarOpen && <span style={{ fontWeight: '500' }}>Upgrade to Pro</span>}
        </div>
      </div>
...
function MenuItem({ icon, text, isOpen, active, onClick }) {
  return (
    <div 
      ...
      {isOpen && <span style={{ fontWeight: active ? 'bold' : 'normal' }}>{text}</span>}
